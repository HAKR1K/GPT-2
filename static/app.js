document.addEventListener("DOMContentLoaded", () => {
    ...
    const rangeTopP = document.getElementById("range-top-p");
    ...
    // Initialize UI Parameter Controls based on selected method
    function updateParameterVisibility() {
        const method = selectMethod.value;
        const tempGroup = document.getElementById("group-temperature");
        const topKGroup = document.getElementById("group-top-k");
        const topPGroup = document.getElementById("group-top-p");
    ...
    selectMethod.addEventListener("change", updateParameterVisibility);
    updateParameterVisibility(); // run on load
    ...
    rangeTopP.addEventListener("input", () => { valTopP.textContent = rangeTopP.value; });
    ...
    btnGenerate.addEventListener("click", async () => {
        ...
        const payload = {
            ...
            top_p: parseFloat(rangeTopP.value)
        };
